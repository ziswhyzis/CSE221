...
public class task5 {
    ...
    static class Pair {
        ...
        Pair(int node, int dist, int parity) {
            this.node = node;
            this.dist = dist;
            this.parity = parity;
        }
    ...
    static int dijkstra(int N, ArrayList<ArrayList<Edge>> graph) {
